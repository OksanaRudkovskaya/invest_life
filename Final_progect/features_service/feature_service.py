...
from src.connectors.pg_conn import PgConnector
from src.resources import pg_queries
...
def get_data():
    ...
    try:
        df = pd.DataFrame(postgres.get_data(pg_queries.sql_get_data))
...
def main():
    ...
    features = ['Close', 'sma_5', 'sma_10', 'sma_15', 'sma_50', 'sma_200', 'sma_ratio_5_15', 'sma_ratio_10_50',
                ...
                # 'cA5', 'cD5', 'cD4', 'cD3', 'cD2', 'cD1',#'wavelet_forecast',
